<script lang="ts">
	...
	import MagazineGrid from '$lib/components/articles/MagazineGrid.svelte';
	import WeitereSidebar from '$lib/components/articles/WeitereSidebar.svelte';
		...
		<div class="container">
			...
			<div class="category-layout">
				...
				<div class="category-sidebar">
					<WeitereSidebar articles={weitereArtikelC} />
				</div>
...
<style>
	...
	.article-thumb { margin-bottom: 24px; overflow: hidden; border-radius: 4px; }
