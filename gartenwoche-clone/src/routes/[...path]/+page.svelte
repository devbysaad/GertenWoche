		...
		<div class="container">
			...
			<div class="cat-layout">
				...
				<section class="cat-main">
					...
					{:else}
						<!-- Featured block: 1 large + 2 small right -->
						{#if featuredLarge}
							<div class="featured-block">
								<a href="/{featuredLarge.urlPath}" class="featured-large">
									<div class="feat-img">
										...
										{:else}
											<div class="feat-placeholder"></div>
										{/if}
								...
								{#if featuredSmall.length > 0}
									<div class="feat-stack">
										{#each featuredSmall as art}
											<a href="/{art.urlPath}" class="feat-small">
												<div class="feat-small-img">
													{#if art.thumbnail}
				...
				<aside class="weitere-sidebar">
					...
					<ul class="weitere-list">
						{#each weitereArtikelC as wa}
							<li class="weitere-item">
								<a href="/{wa.urlPath}" class="weitere-link">
									{#if wa.thumbnail}
										<img src={wa.thumbnail} alt={wa.title} loading="lazy" class="weitere-thumb" />
									{/if}
									<div class="weitere-body">
										<CategoryBadge category={wa.category} />
										<p class="weitere-title">{wa.title}</p>
										<AuthorMeta author={wa.author} publishedAt={wa.publishedAt} />
									</div>
								</a>
							</li>
						{/each}
...
<style>
	...
	@media (max-width: 1023px) {
		.article-layout, .cat-layout { grid-template-columns: 1fr; }
		.article-sidebar, .weitere-sidebar { position: static; }
	}
